...
var fightOrSkip = function() {
  ...
  var promptFight = window.prompt('Would you like to FIGHT or SKIP this battle? Enter "FIGHT" or "SHIP" to choose');
  ...
  promptFight = promptFight.toLowerCase(); // converts any upper case to lower case 
  if (promptFight === "skip") {
...
var shop = function() {
  ...
  shopOptionPrompt = parseInt(shopOptionPrompt); // converts string to integer
...
// function to set name / does not allow a null answer
var getPlayerName = function() {
  var name = "";
  // conditional statement to catch incorrect responses
